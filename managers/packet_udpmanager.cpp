		...
		case 2: {
			...
			switch (subType) {
				case 0: {
					...
					cout << format("[Packet_UdpManager] Client ({}) has sent Packet_Udp - type: {}, subType: {}, localIP: {}.{}.{}.{}, retryNumPortType0: {}, retryNumPortType1: {}\n", packet->GetConnection()->GetEndPoint(), type, subType, (unsigned char)(localIP >> 24), (unsigned char)(localIP >> 16), (unsigned char)(localIP >> 8), (unsigned char)localIP, retryNumPortType0, retryNumPortType1);
					break;
				}
				case 1: {
					unsigned long unk1 = packet->ReadUInt32_LE();
				...
				case 5: {
					...
					cout << format("[Packet_UdpManager] Client ({}) has sent Packet_Udp - type: {}, subType: {}, unk1: {}, unk2: {}{}\n", packet->GetConnection()->GetEndPoint(), type, subType, unk1, unk2, log);
					break;
				}
				default: {
					cout << format("[Packet_UdpManager] Client ({}) has sent unregistered Packet_Udp type: {}, subType: {}!\n", packet->GetConnection()->GetEndPoint(), type, subType);
					break;
				}
			}
