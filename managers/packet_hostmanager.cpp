...
void Packet_HostManager::SendPacket_Host_StartGame(TCPConnection::pointer connection, int userID) {
...
void Packet_HostManager::SendPacket_Host_JoinGame(TCPConnection::pointer connection, int userID) {
	auto packet = TCPConnection::Packet::Create(PacketSource::Server, connection, { PacketID::Host });
